---
tags: [guide, krysalis-os, notebooklm, sop]
---

# 📔 Add NotebookLM to Your Krysalis OS
...
A new section in your Krysalis OS called **Notebook**.
...
- 🎬 Watch videos and listen to audio right inside Krysalis OS.
...
Open Claude Code in your Krysalis OS folder.

Paste this prompt:

```
Add a new "Notebook" section to my Krysalis OS.
...
2. Chat — ask questions about the active notebook using
   ...
   Krysalis OS/Notebooks/<notebook>/chat-YYYY-MM-DD.md.
...
3. Studio — show 9 artifact-type pills (audio, video, slide_deck,
   ...
   and output_path. Save to Krysalis OS/Notebooks/_assets/<notebook>/.
...
download all of them in parallel into Krysalis OS/Notebooks/_assets/.
```
