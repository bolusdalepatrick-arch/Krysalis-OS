...
// Scans ~/.krysalis-os/claude-projects/<project>/. Mirrors the FCC/Hermes
...
export default function ClaudeWorkspace() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[220px_240px_1fr] gap-3 overflow-x-auto" style={{ height: "min(calc(100dvh - 120px), 820px)" }}>
      {/* Projects */}
