            ...
            case "command_started":
              return (
                <motion.div key={e.i} initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  <Loader2 size={13} className="animate-spin shrink-0" style={{ color: "var(--accent-primary)" }} />
                  <div className="min-w-0 flex-1">
                    <div className="text-[10px] uppercase tracking-widest mb-0.5" style={{ color: "var(--accent-primary)" }}>
                      Running command
                    </div>
              ...
              return (
                <motion.div key={e.i} initial={{ opacity: 0, y: 4 }} animate={{ opacity: 1, y: 0 }}
                  ...
                  <button onClick={() => toggleExpanded(e.i)}
                    ...
                    {ok
                      ? <CheckCircle2 size={13} style={{ color: "var(--accent-secondary)" }} className="shrink-0" />
                      : <XCircle size={13} style={{ color: "var(--accent-danger)" }} className="shrink-0" />}
                    <div className="min-w-0 flex-1">
                      <div className="text-[10px] uppercase tracking-widest mb-0.5 flex items-center gap-1.5"
                           style={{ color: ok ? "var(--accent-secondary)" : "var(--accent-danger)" }}>
                        <Terminal size={10} />
            ...
            case "web_search":
              return (
                <motion.div key={e.i} initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                  ...
                  <Globe size={12} style={{ color: "var(--accent-soft)" }} />
                  <div className="text-[10px] uppercase tracking-widest" style={{ color: "var(--accent-soft)" }}>Web search</div>
