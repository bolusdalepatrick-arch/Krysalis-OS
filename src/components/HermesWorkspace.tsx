...
import {
  ...
  ImageIcon, Mic, FileType, Box, Layers, Film, AppWindow, TrendingUp, BookOpen, Sparkles,
} from "lucide-react";
...
function bucketIcon(id: string) {
  ...
  if (id === "gemma4")    return <Sparkles {...props} />;
  if (id === "seo")       return <TrendingUp {...props} />;
  if (id === "guides")    return <BookOpen {...props} />;
