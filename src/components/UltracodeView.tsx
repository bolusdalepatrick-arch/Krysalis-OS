...
const MISSIONS: Mission[] = [
  ...
  },
  {
    ...
    prompt: "Build a dazzling single-file HTML showcase page at index.html for 'Krysalis OS'. Use parallel subagents: hero section, animated feature grid, CSS animation library, closing CTA — then assemble into one self-contained index.html. Dark midnight-aubergine theme (#15101a), gold (#d4a574) + pink (#f472b6) accents, premium animated, fully responsive, zero external deps.",
  },
  {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-4">
        ...
        <div className="panel p-2 flex flex-col" style={{ minHeight: 520 }}>
          <div className="flex items-center justify-between px-2 py-1.5">
            ...
            <button onClick={loadList} aria-label="Refresh" title="Refresh" className="text-[var(--cream-mute)] hover:text-[var(--cream)]"><RefreshCw size={12} /></button>
          </div>
            ...
            {runs.map((r) => (
              <div key={r.id}
                ...
                <div className="flex items-center justify-between gap-2 mb-1">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); del(r.id); }} className="text-[var(--cream-mute)] hover:text-[var(--accent-danger)] shrink-0" title="Delete"><Trash2 size={11} /></button>
                </div>
