...
interface DeployRecord {
  ...
  liveSlug?: string; liveUrl?: string; vercelUrl?: string;
...
export default function SEOView() {
  ...
  useEffect(() => {
    ...
    try {
      const raw = localStorage.getItem("krysalis-os-seo-autodeploy");
  ...
  useEffect(() => {
    try { localStorage.setItem("krysalis-os-seo-autodeploy", autoDeploy ? "1" : "0"); } catch {}
  }, [autoDeploy]);
  ...
  function siteIdFromPath(filePath: string): string | null {
    ...
    if (filePath.includes("/krysalisosaiautomation/")) return "krysalisosautomation";
                ...
                <div key={s.site.id} className="panel p-4 relative overflow-hidden">
                  ...
                  <div className="relative flex items-start justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      >
                        {status === "running" ? (
                          <><span className="tick live" style={{color: accent}}/> Deploying {s.site.name}…</>
                        ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        {d.vercelUrl && d.vercelUrl !== d.liveUrl && (
                          <a
                            href={d.vercelUrl}
                            target="_blank"
                            rel="noopener noreferrer"
                          ...
                          >
                            vercel: <span className="font-[var(--font-geist-mono)]">{d.vercelUrl}</span>
                          </a>
                        )}
