...
// Auto-discover all Hermes profile dirs (krysalisos, swarm10, etc.) so we don't hardcode.
...
export function isAllowedMediaPath(p: string): boolean {
  ...
  // Must be inside HOME (with separator to prevent /Users/krysalisos-other style escape).
