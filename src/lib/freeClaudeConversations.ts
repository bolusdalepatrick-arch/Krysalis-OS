...
// history survives all of that. Stored under ~/.krysalis-os/ alongside other
// AO state.
//
// File format: append-only JSONL. One entry per *completed turn* (Q+A pair).
//   ~/.krysalis-os/freeclaude-conversations.jsonl
//
// Each entry:
...
const STATE_DIR = path.join(HOME, ".krysalis-os");
